...
export const DEFAULT_SEARCH_INDEX = 'https://raw.githubusercontent.com/10o0/TOMATOX_RES/main/result.json';
...
export const IPTV_ORIGIN_URL = 'https://raw.githubusercontent.com/10o0/TOMATOX_RES/main/zhibo.json';
